        ...
        */
        if (this.Get('chart.ylabels')) {
            if (this.Get('chart.xaxispos') == 'center') {
                ...
                RGraph.Text(context, font, text_size, gutter - 5, gutter, RGraph.number_format(this, this.scale[4], units_pre, units_post), 'center', 'right');
                
                
                if (numYLabels >= 5) {
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (1/10) ), RGraph.number_format(this, this.scale[3], units_pre, units_post), 'center', 'right');
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (3/10) ), RGraph.number_format(this, this.scale[1], units_pre, units_post), 'center', 'right');
                }
    
                if (numYLabels >= 3) {
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (2/10) ), RGraph.number_format(this, this.scale[2], units_pre, units_post), 'center', 'right');
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (4/10) ), RGraph.number_format(this, this.scale[0], units_pre, units_post), 'center', 'right');
                }
                
                // Draw the bottom halves labels
                if (numYLabels >= 3) {
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (1/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[0], units_pre, units_post), 'center', 'right');
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (3/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[2], units_pre, units_post), 'center', 'right');
                }
    
                if (numYLabels >= 5) {
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (2/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[1], units_pre, units_post), 'center', 'right');
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (4/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[3], units_pre, units_post), 'center', 'right');
                }
    
                RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (5/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[4], units_pre, units_post), 'center', 'right');
                ...
                if (numYLabels >= 5) {
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (1/5) ), RGraph.number_format(this, this.scale[3], units_pre, units_post), 'center', 'right');
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (3/5) ), RGraph.number_format(this, this.scale[1], units_pre, units_post), 'center', 'right');
                }

                if (numYLabels >= 3) {
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (2/5) ), RGraph.number_format(this, this.scale[2], units_pre, units_post), 'center', 'right');
                    RGraph.Text(context, font, text_size, gutter - 5, gutter + ((canvas.height - (2 * gutter)) * (4/5) ), RGraph.number_format(this, this.scale[0], units_pre, units_post), 'center', 'right');
                }
                
                if (this.Get('chart.ymin')) {
                    RGraph.Text(context, font, text_size, gutter - 5, canvas.height - gutter, RGraph.number_format(this, this.Get('chart.ymin'), units_pre, units_post), 'center', 'right');
                }
            }
        }
